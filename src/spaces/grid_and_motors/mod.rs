...
use bevy::prelude::*;
use crate::{GameState, spaces::grid_and_motors::{events::BackButtonPressed, observers::back_button_pressed_observer}, plugins::{MotorsPlugin, TileMapGridPlugin}};
...
fn setup_grid_and_motors_space(mut commands: Commands, windows: Query<&Window>) {
...
fn startup(commands: Commands, windows: Query<&Window>) {
    setup_grid_and_motors_space(commands, windows);
}
