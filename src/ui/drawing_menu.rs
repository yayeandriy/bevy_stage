...
impl Plugin for DrawingMenuPlugin {
    fn build(&self, app: &mut App) {
        app.add_systems(OnEnter(GameState::Motors), setup_menu)
            .add_systems(Update, click_play_button.run_if(in_state(GameState::Motors)))
            .add_systems(OnExit(GameState::Motors), cleanup_menu);
    }
}
